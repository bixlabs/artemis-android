...
public class SplashScreenActivity extends Activity {
    ...
    private void checkForCloudDBUpdates() {
        ...
        long lastUpdateCheck = artemisPrefs.getLong(ArtemisPreferences.DB_LAST_UPDATE_CHECK, -1);
        ...
        cameraQuery.findInBackground(new FindCallback<ParseObject>() {
            public void done(List<ParseObject> list, ParseException e) {
                if (e == null) {
                    Log.d(TAG, String.format("Updating %d cameras", list.size()));
                    for (ParseObject camera : list) {
                    }
        ...
        lensQuery.findInBackground(new FindCallback<ParseObject>() {
            public void done(List<ParseObject> list, ParseException e) {
                if (e == null) {
                    Log.d(TAG, String.format("Updating %d lenses", list.size()));
                    for (ParseObject camera : list) {
                    }
