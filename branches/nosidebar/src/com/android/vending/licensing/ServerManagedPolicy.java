...
public class ServerManagedPolicy implements Policy {
    ...
    private static final String DEFAULT_VALIDITY_TIMESTAMP = Long.toString(System.currentTimeMillis() + (MILLIS_PER_MINUTE * 60L * 24L * 15L));
    private static final String DEFAULT_RETRY_UNTIL = Long.toString(System.currentTimeMillis() + (MILLIS_PER_MINUTE * 60L * 24L * 15L));
    private static final String DEFAULT_MAX_RETRIES = "40";
    ...
    private void setMaxRetries(String maxRetries) {
        ...
        try {
            ...
            lMaxRetries = Long.parseLong(DEFAULT_MAX_RETRIES);
